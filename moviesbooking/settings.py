"""
Django settings for moviesbooking project.
...
SECRET_KEY = 'django-insecure-q0!4-(3)cn3*kxc#$nfus9h88tu-41q7cdt57-v7t_0dm%sl$+'
...
ROOT_URLCONF = 'moviesbooking.urls'
...
WSGI_APPLICATION = 'moviesbooking.wsgi.application'
